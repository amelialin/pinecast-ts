...
const ToolbarButton = (
    {children, id, page: currentPage, switchPage}: ToolbarButtonProps
) =>
    <button
        onClick={e => {
            e.preventDefault();
        ...
        style={{
            ...
            border: 0,
            borderRadius: 3,
            boxShadow: `0 7px 14px rgba(50, 50, 100, ${id === currentPage ? '0.3' : '0.15'}), 0 3px 6px rgba(0, 0, 0, 0.15)${insetShadow(id === currentPage)}`,
