...
import previewReducer, {initialState as previewInitialState, ReducerType as PreviewReducerType} from './reducers/preview';
...
const reducer = (state: ReducerType = initialState, action): ReducerType => (
    state ?
        {
            ...state,
            page: actionReducer<ReducerType['page']>('switchPage', (state, action) => action.payload)(state.page, action),
